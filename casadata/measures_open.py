...
def measures_open(path=None):
    """
    Open the measures data at the specified path

    Parameters
    ----------
    path : str
        Folder path to the measures data. Default None looks in current working directory

    Returns
    -------
    xarray.core.dataset.Dataset
        Main xarray dataset of datasets for this measures set
